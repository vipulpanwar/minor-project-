                ...
                <div className={styles.rightcontainer}>
                    ...
                    <form>
                        ...
                        <div className={styles.leftForm}>
                            ...
                            {this.state.founded_in && this.state.size && this.state.about && this.state.email && this.state.phone && <button type = "submit" onClick={this.createaccount} className={styles.createButton}>Create Account</button>}
                            {!(this.state.founded_in && this.state.size && this.state.about && this.state.email && this.state.phone) && <button type = "submit" className={styles.createButtonInactive}>Create Account</button>}
                    </form>
                </div>
            </div>
        )
